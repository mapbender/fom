...
class UserController extends Controller {
    ...
    public function editAction($id) {
        ...
        $form = $this->createForm(new UserType(), $user, array('requirePassword' => false));
    ...
    /**
     * @ManagerRoute("/user/resetpass/{token}")
     * @Method({"GET"})
    ...
    /**
     * @ManagerRoute("/user/registerconfirm/{token}")
     * @Method({"GET"})
    ...
    /**
     * @ManagerRoute("/user/registerreset/{token}")
     * @Method({"POST"})
